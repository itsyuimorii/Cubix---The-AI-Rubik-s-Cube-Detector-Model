...
IMAGE_PATHS = glob.glob(os.path.join("images", "validation", "input", "*.png"))
OUTPUT_PATH = os.path.join("images", "validation", "output")
...
for image_path in IMAGE_PATHS:
    ...
    print(f'Running inference for {file_name}... ', end='')
    ...
    im.save(os.path.join(OUTPUT_PATH, file_name))
    print('Done')
